...
const ISMUL = () => {
    ...
    const imagenmapa = 'https://firebasestorage.googleapis.com/v0/b/upra-guide.appspot.com/o/leafletImg%2FIsmul_leaflet_PN.png?alt=media&token=2f5dd649-6782-4006-84b0-afec366a8c18'
//BOTONES DE USO=============================================================================================================================
...
//BOTONES DE USO=============================================================================================================================
  ...
  const ExtintorLocations = [
   ...
   const MeetingPointLocations = [
    [81.341117, -50.625000],[83.984598, 829.687500],[-81.005991, 869.765625]
  ...
  const getAltPolylinePositions = (name) => {
    switch (name) {
      ...
      case 'ISMUL AC334':
          ...
          case 'INGLES':
            return [[-0.616343, 767.460938],[-0.616343, 826.875000],[-70.082435, 826.875000],[-80.439894, 866.25]];
...
return (
  ...
  <div className='leafletcss1'>   
    ...
    <MapContainer center={[11.178402, 395.15625]} zoom={1}ref={mapRef}>
...
<RecenterButton handleCenterMap={handleCenterMap} center={[11.178402, 395.15625]} zoom={1} />
{/*Boton de reset===============================*/}
