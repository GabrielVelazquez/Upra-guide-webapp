...
//Coordenadas de los extintores-----------------------------------------------------------------------------------------------------------
  const ExtintorLocations = [
   [-82.678851, -26.542969],
   [53.319779, 686.953125]

  ];

  const PullStationLocations = [
   [53.319779, 665.156250],
   [-82.678851, -49.638672]
...
//COORDENADAS DE RUTAS DE SALIDAS y nombre de salon (para el case)-------------------------------------------------------------------------
  const getPolylinePositions = (name) => {
    switch (name) {
      ...
      case 'AC102':
        return [[60.649662, 124.233398],[55.906543, 124.233398],[55.906543, 98.789063],[17.028871, 98.789063],[17.028871, 5.097656],[71.330647, 5.097656]];

      case 'AC103':
        return [[48.265841, 259.453125],[55.906543, 259.453125],[55.906543, 124.233398],[55.906543, 98.789063],[17.028871, 98.789063],[17.028871, 5.097656],[71.330647, 5.097656]];
      
      case 'AC104':
        return [[60.649662, 259.453125],[55.906543, 259.453125],[55.906543, 124.233398],[55.906543, 98.789063],[17.028871, 98.789063],[17.028871, 5.097656],[71.330647, 5.097656]];

      case 'AC105':
        return [[48.265841, 279.492188],[55.906543, 279.492188],[55.906543, 124.233398],[55.906543, 98.789063],[17.028871, 98.789063],[17.028871, 5.097656],[71.330647, 5.097656]];
      
      case 'AC106':
        return [[60.649662, 279.492188],[55.906543, 279.492188],[55.906543, 124.233398],[55.906543, 98.789063],[17.028871, 98.789063],[17.028871, 5.097656],[71.330647, 5.097656]];
      
      case 'AC107':
        return [[71.467489, 407.283203], [74.148744,407.283203],[74.166234, 766.041135], [76.88191, 766.041135]];


      case 'AC108':
        return [[55.799463, 400.221680],[44.702472, 400.221680],[44.702472, 861.503906],  [62.428157, 861.503906]];
  ...
  const getAltPolylinePositions = (name) => {
    switch (name) {
      case 'AC101':
        return [[-53.958744, 63.820313],[-40.450481, 63.820313],[-40.450481, 358.59375],[40.440367, 358.59375],[40.440367, 861.503906],  [62.428157, 861.503906]];
      case 'AC108':
